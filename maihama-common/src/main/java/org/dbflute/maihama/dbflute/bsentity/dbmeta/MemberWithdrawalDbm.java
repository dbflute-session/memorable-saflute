 ...
 */
package org.dbflute.maihama.dbflute.bsentity.dbmeta;
...
import org.dbflute.maihama.dbflute.allcommon.*;
...
public class MemberWithdrawalDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberId = cci("MEMBER_ID", "MEMBER_ID", null, "メンバーID", Integer.class, "memberId", null, true, false, true, "INT", 10, 0, null, null, false, null, null, "member", null, null, false);
    ...
    protected final ColumnInfo _columnRegisterDatetime = cci("REGISTER_DATETIME", "REGISTER_DATETIME", null, "登録日付時間", java.time.LocalDateTime.class, "registerDatetime", null, false, false, true, "DATETIME", 19, 0, null, null, true, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.dbflute.maihama.dbflute.exentity.MemberWithdrawal"; }
    public String getConditionBeanTypeName() { return "org.dbflute.maihama.dbflute.cbean.MemberWithdrawalCB"; }
    public String getBehaviorTypeName() { return "org.dbflute.maihama.dbflute.exbhv.MemberWithdrawalBhv"; }
