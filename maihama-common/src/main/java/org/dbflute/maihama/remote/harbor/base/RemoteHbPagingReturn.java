 ...
 */
package org.dbflute.maihama.remote.harbor.base;
 ...
 * @author jflute
 */
public class RemoteHbPagingReturn<BEAN> {
    ...
    public RemoteHbPagingReturn(PagingResultBean<? extends Entity> page, List<BEAN> rows) {
