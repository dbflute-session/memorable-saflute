...
public class ServiceRankDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "${packageName}.dbflute.exentity.ServiceRank"; }
    public String getConditionBeanTypeName() { return "${packageName}.dbflute.cbean.ServiceRankCB"; }
    public String getBehaviorTypeName() { return "${packageName}.dbflute.exbhv.ServiceRankBhv"; }
