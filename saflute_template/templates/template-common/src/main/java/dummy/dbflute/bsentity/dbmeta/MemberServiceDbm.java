...
public class MemberServiceDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "${packageName}.dbflute.exentity.MemberService"; }
    public String getConditionBeanTypeName() { return "${packageName}.dbflute.cbean.MemberServiceCB"; }
    public String getBehaviorTypeName() { return "${packageName}.dbflute.exbhv.MemberServiceBhv"; }
