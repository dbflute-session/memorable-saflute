...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("member", "${packageName}.dbflute.bsentity.dbmeta.MemberDbm");
        tmpMap.put("member_address", "${packageName}.dbflute.bsentity.dbmeta.MemberAddressDbm");
        tmpMap.put("member_following", "${packageName}.dbflute.bsentity.dbmeta.MemberFollowingDbm");
        tmpMap.put("member_login", "${packageName}.dbflute.bsentity.dbmeta.MemberLoginDbm");
        tmpMap.put("member_security", "${packageName}.dbflute.bsentity.dbmeta.MemberSecurityDbm");
        tmpMap.put("member_service", "${packageName}.dbflute.bsentity.dbmeta.MemberServiceDbm");
        tmpMap.put("member_status", "${packageName}.dbflute.bsentity.dbmeta.MemberStatusDbm");
        tmpMap.put("member_withdrawal", "${packageName}.dbflute.bsentity.dbmeta.MemberWithdrawalDbm");
        tmpMap.put("product", "${packageName}.dbflute.bsentity.dbmeta.ProductDbm");
        tmpMap.put("product_category", "${packageName}.dbflute.bsentity.dbmeta.ProductCategoryDbm");
        tmpMap.put("product_status", "${packageName}.dbflute.bsentity.dbmeta.ProductStatusDbm");
        tmpMap.put("purchase", "${packageName}.dbflute.bsentity.dbmeta.PurchaseDbm");
        tmpMap.put("purchase_payment", "${packageName}.dbflute.bsentity.dbmeta.PurchasePaymentDbm");
        tmpMap.put("region", "${packageName}.dbflute.bsentity.dbmeta.RegionDbm");
        tmpMap.put("service_rank", "${packageName}.dbflute.bsentity.dbmeta.ServiceRankDbm");
        tmpMap.put("withdrawal_reason", "${packageName}.dbflute.bsentity.dbmeta.WithdrawalReasonDbm");
