...
public class MemberLoginDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "${packageName}.dbflute.exentity.MemberLogin"; }
    public String getConditionBeanTypeName() { return "${packageName}.dbflute.cbean.MemberLoginCB"; }
    public String getBehaviorTypeName() { return "${packageName}.dbflute.exbhv.MemberLoginBhv"; }
