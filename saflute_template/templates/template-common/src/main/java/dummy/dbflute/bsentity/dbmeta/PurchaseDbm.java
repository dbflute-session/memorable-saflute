...
public class PurchaseDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "${packageName}.dbflute.exentity.Purchase"; }
    public String getConditionBeanTypeName() { return "${packageName}.dbflute.cbean.PurchaseCB"; }
    public String getBehaviorTypeName() { return "${packageName}.dbflute.exbhv.PurchaseBhv"; }
