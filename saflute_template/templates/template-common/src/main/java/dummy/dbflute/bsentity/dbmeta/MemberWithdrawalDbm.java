 ...
 */
package ${packageName}.dbflute.bsentity.dbmeta;
...
import ${packageName}.dbflute.allcommon.*;
import ${packageName}.dbflute.exentity.*;
...
public class MemberWithdrawalDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "${packageName}.dbflute.exentity.MemberWithdrawal"; }
    public String getConditionBeanTypeName() { return "${packageName}.dbflute.cbean.MemberWithdrawalCB"; }
    public String getBehaviorTypeName() { return "${packageName}.dbflute.exbhv.MemberWithdrawalBhv"; }
