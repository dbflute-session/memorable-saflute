...
public class RegionDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "${packageName}.dbflute.exentity.Region"; }
    public String getConditionBeanTypeName() { return "${packageName}.dbflute.cbean.RegionCB"; }
    public String getBehaviorTypeName() { return "${packageName}.dbflute.exbhv.RegionBhv"; }
