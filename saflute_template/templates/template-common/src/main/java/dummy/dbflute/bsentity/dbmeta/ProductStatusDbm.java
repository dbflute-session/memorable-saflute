...
public class ProductStatusDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "${packageName}.dbflute.exentity.ProductStatus"; }
    public String getConditionBeanTypeName() { return "${packageName}.dbflute.cbean.ProductStatusCB"; }
    public String getBehaviorTypeName() { return "${packageName}.dbflute.exbhv.ProductStatusBhv"; }
