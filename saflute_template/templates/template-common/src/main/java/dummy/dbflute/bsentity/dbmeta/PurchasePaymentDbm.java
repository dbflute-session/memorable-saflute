...
public class PurchasePaymentDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "${packageName}.dbflute.exentity.PurchasePayment"; }
    public String getConditionBeanTypeName() { return "${packageName}.dbflute.cbean.PurchasePaymentCB"; }
    public String getBehaviorTypeName() { return "${packageName}.dbflute.exbhv.PurchasePaymentBhv"; }
