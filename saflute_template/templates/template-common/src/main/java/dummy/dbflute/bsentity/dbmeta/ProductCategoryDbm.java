...
public class ProductCategoryDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "${packageName}.dbflute.exentity.ProductCategory"; }
    public String getConditionBeanTypeName() { return "${packageName}.dbflute.cbean.ProductCategoryCB"; }
    public String getBehaviorTypeName() { return "${packageName}.dbflute.exbhv.ProductCategoryBhv"; }
