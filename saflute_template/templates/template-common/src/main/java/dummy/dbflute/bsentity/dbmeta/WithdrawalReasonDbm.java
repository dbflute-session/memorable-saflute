...
public class WithdrawalReasonDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "${packageName}.dbflute.exentity.WithdrawalReason"; }
    public String getConditionBeanTypeName() { return "${packageName}.dbflute.cbean.WithdrawalReasonCB"; }
    public String getBehaviorTypeName() { return "${packageName}.dbflute.exbhv.WithdrawalReasonBhv"; }
