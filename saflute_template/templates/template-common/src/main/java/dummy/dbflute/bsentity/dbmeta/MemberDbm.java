...
public class MemberDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "${packageName}.dbflute.exentity.Member"; }
    public String getConditionBeanTypeName() { return "${packageName}.dbflute.cbean.MemberCB"; }
    public String getBehaviorTypeName() { return "${packageName}.dbflute.exbhv.MemberBhv"; }
