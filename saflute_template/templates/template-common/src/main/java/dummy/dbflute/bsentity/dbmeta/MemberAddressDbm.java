...
public class MemberAddressDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "${packageName}.dbflute.exentity.MemberAddress"; }
    public String getConditionBeanTypeName() { return "${packageName}.dbflute.cbean.MemberAddressCB"; }
    public String getBehaviorTypeName() { return "${packageName}.dbflute.exbhv.MemberAddressBhv"; }
