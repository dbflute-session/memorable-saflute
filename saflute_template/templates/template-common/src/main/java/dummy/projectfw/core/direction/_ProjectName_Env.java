 ...
 * @author FreeGen
 */
public interface ${ProjectName}Env {
    ...
    /** The key of the configuration. e.g. jdbc:mysql://localhost:3306/${projectname}db */
    String JDBC_URL = "jdbc.url";

    /** The key of the configuration. e.g. ${projectname}user */
    String JDBC_USER = "jdbc.user";

    /** The key of the configuration. e.g. ${projectname}word */
     ...
     * The value is, e.g. jdbc:mysql://localhost:3306/${projectname}db <br />
     ...
     * The value is, e.g. ${projectname}user <br />
     ...
     * The value is, e.g. ${projectname}word <br />
     ...
     */
    public static class SimpleImpl extends ObjectiveConfig implements ${ProjectName}Env {
        ...
        public String getDevelopmentHere() {
            return get(${ProjectName}Env.DEVELOPMENT_HERE);
        }
        ...
        public boolean isDevelopmentHere() {
            return is(${ProjectName}Env.DEVELOPMENT_HERE);
        }
        ...
        public String getEnvironmentTitle() {
            return get(${ProjectName}Env.ENVIRONMENT_TITLE);
        }
        ...
        public String getFrameworkDebug() {
            return get(${ProjectName}Env.FRAMEWORK_DEBUG);
        }
        ...
        public boolean isFrameworkDebug() {
            return is(${ProjectName}Env.FRAMEWORK_DEBUG);
        }
        ...
        public String getTimeAdjustTimeMillis() {
            return get(${ProjectName}Env.TIME_ADJUST_TIME_MILLIS);
        }
        ...
        public Long getTimeAdjustTimeMillisAsLong() {
            return getAsLong(${ProjectName}Env.TIME_ADJUST_TIME_MILLIS);
        }
        ...
        public String getMailSendMock() {
            return get(${ProjectName}Env.MAIL_SEND_MOCK);
        }
        ...
        public boolean isMailSendMock() {
            return is(${ProjectName}Env.MAIL_SEND_MOCK);
        }
        ...
        public String getMailSmtpServerDefaultHostAndPort() {
            return get(${ProjectName}Env.MAIL_SMTP_SERVER_DEFAULT_HOST_AND_PORT);
        }
        ...
        public String getJdbcUrl() {
            return get(${ProjectName}Env.JDBC_URL);
        }
        ...
        public String getJdbcUser() {
            return get(${ProjectName}Env.JDBC_USER);
        }
        ...
        public String getJdbcPassword() {
            return get(${ProjectName}Env.JDBC_PASSWORD);
        }
        ...
        public String getJdbcConnectionPoolingSize() {
            return get(${ProjectName}Env.JDBC_CONNECTION_POOLING_SIZE);
        }
        ...
        public Integer getJdbcConnectionPoolingSizeAsInteger() {
            return getAsInteger(${ProjectName}Env.JDBC_CONNECTION_POOLING_SIZE);
        }
    }
}
