...
import ${packageName}.projectfw.core.direction.${ProjectName}Env;

/**
 * @author FreeGen
 */
public interface ${ProjectName}Config extends ${ProjectName}Env {
     ...
     */
    public static class SimpleImpl extends ${ProjectName}Env.SimpleImpl implements ${ProjectName}Config {

        private static final long serialVersionUID = 1L;

        /** {@inheritDoc} */
        public String getDomainTitle() {
            return get(${ProjectName}Config.DOMAIN_TITLE);
        }

        /** {@inheritDoc} */
        public String getCookieDefaultPath() {
            return get(${ProjectName}Config.COOKIE_DEFAULT_PATH);
        }

        /** {@inheritDoc} */
        public String getCookieDefaultExpire() {
            return get(${ProjectName}Config.COOKIE_DEFAULT_EXPIRE);
        }

        /** {@inheritDoc} */
        public Integer getCookieDefaultExpireAsInteger() {
            return getAsInteger(${ProjectName}Config.COOKIE_DEFAULT_EXPIRE);
        }

        /** {@inheritDoc} */
        public String getCookieEternalExpire() {
            return get(${ProjectName}Config.COOKIE_ETERNAL_EXPIRE);
        }

        /** {@inheritDoc} */
        public Integer getCookieEternalExpireAsInteger() {
            return getAsInteger(${ProjectName}Config.COOKIE_ETERNAL_EXPIRE);
        }

        /** {@inheritDoc} */
        public String getPagingPageSize() {
            return get(${ProjectName}Config.PAGING_PAGE_SIZE);
        }

        /** {@inheritDoc} */
        public Integer getPagingPageSizeAsInteger() {
            return getAsInteger(${ProjectName}Config.PAGING_PAGE_SIZE);
        }

        /** {@inheritDoc} */
        public String getPagingPageRangeSize() {
            return get(${ProjectName}Config.PAGING_PAGE_RANGE_SIZE);
        }

        /** {@inheritDoc} */
        public Integer getPagingPageRangeSizeAsInteger() {
            return getAsInteger(${ProjectName}Config.PAGING_PAGE_RANGE_SIZE);
        }

        /** {@inheritDoc} */
        public String getPagingPageRangeFillLimit() {
            return get(${ProjectName}Config.PAGING_PAGE_RANGE_FILL_LIMIT);
        }

        /** {@inheritDoc} */
        public boolean isPagingPageRangeFillLimit() {
            return is(${ProjectName}Config.PAGING_PAGE_RANGE_FILL_LIMIT);
        }

        /** {@inheritDoc} */
        public String getMinimumYear() {
            return get(${ProjectName}Config.MINIMUM_YEAR);
        }

        /** {@inheritDoc} */
        public Integer getMinimumYearAsInteger() {
            return getAsInteger(${ProjectName}Config.MINIMUM_YEAR);
        }
    }
}
