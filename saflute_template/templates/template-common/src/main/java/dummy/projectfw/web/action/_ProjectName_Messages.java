 ...
 * @author FreeGen
 */
public class ${ProjectName}Messages extends ActionMessages {
    ...
    public static final String MESSAGES_INPUT_NOTE_EMAILORACCOUNT = "messages.input.note.emailOrAccount";
    ...
    public static final String MESSAGES_INPUT_NOTE_ZIPCODE = "messages.input.note.zipCode";
    ...
    public void addMessagesInputNoteEmailoraccount(String property) {
        assertPropertyNotNull(property);
        add(property, new ActionMessage(MESSAGES_INPUT_NOTE_EMAILORACCOUNT, (Object[])null));
    }
    ...
    public void addMessagesInputNoteZipcode(String property) {
        assertPropertyNotNull(property);
        add(property, new ActionMessage(MESSAGES_INPUT_NOTE_ZIPCODE, (Object[])null));
    }
    ...
    public static interface LabelKey {
        ...
        String LABELS_MEMBERID = "labels.memberId";

        /** The key of the label: 会員名称 */
        String LABELS_MEMBERNAME = "labels.memberName";

        /** The key of the label: メールアドレス */
        String LABELS_EMAIL = "labels.email";

        /** The key of the label: メアドじゃなくてアカウント */
        String LABELS_EMAILORACCOUNT = "labels.emailOrAccount";

        /** The key of the label: パスワード */
        String LABELS_PASSWORD = "labels.password";

        /** The key of the label: バージョンNo */
        String LABELS_VERSIONNO = "labels.versionNo";
