...
import org.dbflute.saflute.web.action.exception.WrongUrlChainUseException;
...
public class UrlChain {
     ...
     * The name and specification of this method is synchronized with {@link RootAction#moreUrl()}.
     ...
     * The name and specification of this method is synchronized with {@link RootAction#params()}.
     ...
     * The name and specification of this method is synchronized with {@link RootAction#hash()}.
