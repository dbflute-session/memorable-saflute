 ...
 * @author jflute
 */
public class MessageResourceBundleWrapper implements MessageResourceBundle, Comparable<MessageResourceBundle> {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public MessageResourceBundleWrapper(MessageResourceBundle wrappedBundle, boolean defaultLang, Integer parentLevel,
    ...
    public int compareTo(MessageResourceBundle you) {
        final MessageResourceBundleWrapper wrappedYou = (MessageResourceBundleWrapper) you;
    ...
    public int compareToByDefaultLang(MessageResourceBundleWrapper bundle) {
    ...
    public int compareToByParent(MessageResourceBundleWrapper bundle) {
    ...
    public int compareToByExtends(MessageResourceBundleWrapper bundle) {
        // ordered: null or smaller
