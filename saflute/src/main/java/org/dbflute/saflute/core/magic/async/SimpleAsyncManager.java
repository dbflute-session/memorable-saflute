 ...
 */
package org.dbflute.saflute.core.magic.async;
...
import org.dbflute.saflute.core.magic.async.ConcurrentAsyncOption.ConcurrentAsyncInheritType;
...
public class SimpleAsyncManager implements AsyncManager {
    ...
    //                                                                          Definition
    //                                                                          ==========
    private static final Log LOG = LogFactory.getLog(SimpleAsyncManager.class);
