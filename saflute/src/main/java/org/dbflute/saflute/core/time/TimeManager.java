...
public interface TimeManager {
    ...
    /**
     * Get the local date-time that specifies current time for business. <br>
     * The word 'current' means transaction beginning in transaction if default setting of Framework. <br>
     * You can get the same date (but different instances) in the same transaction.
    ...
    /**
     * Get the date that specifies current time for business. <br>
     * The word 'current' means transaction beginning in transaction if default setting of Framework. <br>
     * You can get the same date (but different instances) in the same transaction.
     * @return The date that has current time. (NotNull)
     */
    Date getCurrentDate();
     ...
     * You can adjust it by {@link FwAssistantDirector}.
