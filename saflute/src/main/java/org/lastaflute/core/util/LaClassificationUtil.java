...
public class LaClassificationUtil {
    ...
    public static class ClassificationFindByCodeMethodNotFoundException extends RuntimeException {
        ...
        public ClassificationFindByCodeMethodNotFoundException(String msg, MethodNotFoundRuntimeException e) {
            super(msg, e);
        }
    }
    ...
    public static class ClassificationMetaFindMethodNotFoundException extends RuntimeException {
        ...
        public ClassificationMetaFindMethodNotFoundException(String msg, MethodNotFoundRuntimeException e) {
            super(msg, e);
        }
    }
    ...
    public static class ClassificationCodeOfMethodNotFoundException extends RuntimeException {
        ...
        public ClassificationCodeOfMethodNotFoundException(String msg, MethodNotFoundRuntimeException e) {
            super(msg, e);
        }
    }
    ...
    public static class ClassificationMetaOfMethodNotFoundException extends RuntimeException {
        ...
        public ClassificationMetaOfMethodNotFoundException(String msg, MethodNotFoundRuntimeException e) {
            super(msg, e);
        }
    }
